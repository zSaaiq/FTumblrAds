...
@interface _TtC9ComposeUI36ComposeKanvasCameraAnalyticsProvider : NSObject
{
...
- (void)logAdvancedOptionsOpenWithPage:(id)arg1;
- (void)logEditorStickerMoveWithStickerId:(id)arg1;
- (void)logEditorStickerRemoveWithStickerId:(id)arg1;
- (void)logEditorStickerAddWithStickerId:(id)arg1;
- (void)logEditorStickerPackSelectWithStickerPackId:(id)arg1;
...
- (id)initWithAnalyticsBuffer:(id)arg1 screen:(long long)arg2;
