...
@class NSArray, NSSet, NSString, TMReblogPostParameters;
...
@interface TMComposeReblogPostDataSource : NSObject <TMComposePostDataSource>
{
    _Bool _editing;
    NSArray *_cells;
    ...
    TMReblogPostParameters *_postParameters;
...
@property(readonly, nonatomic) TMReblogPostParameters *postParameters; // @synthesize postParameters=_postParameters;
