...
@class GADActiveViewMonitor, GADAdExposureMonitor, GADGestureRecognizer, GADImpressionMonitor, GADNativeAd, GADNativeAdTapGestureRecognizer, GADOverlayView, GADSDKCoreWebView, NSMapTable, NSMutableArray, NSString, UIView;
