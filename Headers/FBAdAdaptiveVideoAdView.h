...
@class FBAdAudioMuteButton, FBAdBlurredOverlayView, FBAdCTAButton, FBAdLabel, FBAdTimer, FBAdVideoPlayPauseButton, FBAdVideoProgressBar, FBGradientView, FBNativeAdDataModel, NSLayoutConstraint, NSString, UIButton, UIStackView, UIView, UIViewController;
