...
@class NSArray, NSSet, NSString, TMTextPostParameters;
@protocol TMCellsTransformer, TMComposeDataChangeDelegate, TMComposeDataSourceTableViewHandler, TMComposeFieldTableCellDelegate, TMComposeFooterViewGIFButtonDelegate, TMSession, TMTumblrCoreDataController;

@interface TMComposeTextPostDataSource : NSObject <TMComposePostDataSource>
{
    _Bool _editing;
    NSArray *_cells;
...
@property(readonly, nonatomic) id <TMSession> URLSession; // @synthesize URLSession=_URLSession;
...
@property(readonly, nonatomic) TMTextPostParameters *postParameters; // @synthesize postParameters=_postParameters;
...
- (void)reloadCells;
- (id)init;
- (id)initWithParameters:(id)arg1 session:(id)arg2 composeHeight:(double)arg3 isEditing:(_Bool)arg4 cellsTransformer:(id)arg5 permittedTagNames:(id)arg6 dataChangeDelegate:(id)arg7 GIFButtonDelegate:(id)arg8 URLSession:(id)arg9 coreDataController:(id)arg10;
