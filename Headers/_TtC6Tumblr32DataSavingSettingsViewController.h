...
@interface _TtC6Tumblr32DataSavingSettingsViewController : UITableViewController
{
...
- (id)initWithAppColorScheme:(id)arg1 session:(id)arg2 analyticsBuffer:(id)arg3 preferences:(id)arg4 delegate:(id)arg5;
