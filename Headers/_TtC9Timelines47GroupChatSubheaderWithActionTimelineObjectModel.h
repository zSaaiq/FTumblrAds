...
@interface _TtC9Timelines47GroupChatSubheaderWithActionTimelineObjectModel : NSObject
{
...
- (id)initWithIdentifier:(id)arg1 commonValues:(id)arg2 text:(id)arg3 count:(long long)arg4 action:(id)arg5;
