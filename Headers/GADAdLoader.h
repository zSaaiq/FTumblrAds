...
@class GADAdLoadResults, GADAdLoaderConfiguration, GADSlot, NSMutableArray, NSString, UIViewController;
...
- (void)createSingleNativeAd:(id)arg1 slot:(id)arg2 index:(long long)arg3;
