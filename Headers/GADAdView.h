...
@class GADAd, GADAdViewActiveViewReporter, GADAdViewState, GADAdViewVideoController, GADClearcutLogger, GADVideoPlayer, GADWebView, GADWiggleGestureRecognizer, NSOperationQueue, NSString, NSURL, UIGestureRecognizer, UIScrollView, UIViewController;
