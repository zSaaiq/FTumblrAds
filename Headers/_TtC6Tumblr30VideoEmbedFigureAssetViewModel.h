...
#import "TMVideoEmbedStaticFigureViewDelegate-Protocol.h"
...
@interface _TtC6Tumblr30VideoEmbedFigureAssetViewModel : NSObject <TMVideoEmbedStaticFigureViewDelegate>
{
    MISSING_TYPE *thumbnailURLString;
    MISSING_TYPE *player;
    MISSING_TYPE *placeholderImageURLString;
    MISSING_TYPE *shouldPlayInline;
...
- (void)figureView:(id)arg1 didTapPlayView:(id)arg2;
