...
+ (long long)_compareOperatingSystemVersion:(CDStruct_f6aba300)arg1 toVersion:(CDStruct_f6aba300)arg2;
...
+ (CDStruct_f6aba300)operatingSystemVersion;
...
+ (_Bool)isOSRunTimeVersionAtLeast:(CDStruct_f6aba300)arg1;
