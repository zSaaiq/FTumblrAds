...
@class NSArray, NSSet, NSString, TMQuotePostParameters;
...
@interface TMComposeQuotePostDataSource : NSObject <TMComposePostDataSource>
{
    _Bool _editing;
    NSArray *_cells;
    ...
    TMQuotePostParameters *_postParameters;
...
@property(readonly, nonatomic) TMQuotePostParameters *postParameters; // @synthesize postParameters=_postParameters;
