...
#import "TMAnswerControllerDelegate-Protocol.h"
#import "TMComposePostDataSource-Protocol.h"

@class NSArray, NSSet, NSString, TMAnswerController, TMAnswerPostParameters;
...
@interface TMComposeAnswerPostDataSource : NSObject <TMAnswerControllerDelegate, TMComposePostDataSource>
{
    _Bool _editing;
    _Bool _isAnonymous;
    NSArray *_cells;
    ...
    TMAnswerController *_answerController;
...
@property(readonly, nonatomic) TMAnswerPostParameters *postParameters; // @synthesize postParameters=_postParameters;
@property(retain, nonatomic) TMAnswerController *answerController; // @synthesize answerController=_answerController;
...
- (id)privateSwitchCell;
- (id)answerBodyCell;
- (void)reloadCells;
- (void)answerControllerDidChangePrivateSwitchCellDisplayability;
- (id)initWithParameters:(id)arg1 session:(id)arg2 composeHeight:(double)arg3 isEditing:(_Bool)arg4 cellsTransformer:(id)arg5 permittedTagNames:(id)arg6 dataChangeDelegate:(id)arg7 isAnonymous:(_Bool)arg8 GIFButtonDelegate:(id)arg9;
- (id)init;
