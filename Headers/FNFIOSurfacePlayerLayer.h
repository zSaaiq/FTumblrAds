...
@class CADisplayLink, FNFRenderingThread, NSError, NSObject, NSString;
...
@interface FNFIOSurfacePlayerLayer : CALayer <FNFDecompressionSessionDelegate, CALayerDelegate, FNFPlayerDisplayEngine, FNFAVPlayerLayer>
{
    ...
    _Bool _combineAdvanceFrameWithFindNextFrame;
    _Bool _useSharedPixelBufferPool;
...
- (void)_drawFrame;
- (void)_decodePixelBuffer:(struct __CVBuffer *)arg1;
...
- (id)initWithConfig:(CDStruct_8bee7ff7)arg1 andCodecMap:(struct NSDictionary *)arg2;
- (id)initWithConfig:(CDStruct_8bee7ff7)arg1;
