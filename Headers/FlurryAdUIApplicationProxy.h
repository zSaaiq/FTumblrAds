...
@class FlurryAdActorDeferredQueue;

@interface FlurryAdUIApplicationProxy : FlurryAdActor
{
    long long _statusBarOrientation;
    long long _applicationState;
    FlurryAdActorDeferredQueue *_deferredQ;
}

+ (id)sharedInstance;
@property(retain, nonatomic) FlurryAdActorDeferredQueue *deferredQ; // @synthesize deferredQ=_deferredQ;
