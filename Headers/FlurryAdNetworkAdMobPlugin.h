...
@property(retain, nonatomic) GADInterstitial *currentInterstitial; // @synthesize currentInterstitial;
@property(retain, nonatomic) GADBannerView *currentBanner; // @synthesize currentBanner;
