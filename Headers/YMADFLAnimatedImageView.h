...
@class CADisplayLink, FlurryTrackingManager, NSString, UIImage, YMADFLAnimatedImage;

@interface YMADFLAnimatedImageView : UIImageView <IFlurryTrackingManagerDelegate>
{
    _Bool _shouldAnimate;
    _Bool _needsDisplayWhenImageBecomesAvailable;
    NSString *_runLoopMode;
    YMADFLAnimatedImage *_animatedImage;
    ...
    FlurryTrackingManager *_trackingManager;
}

+ (id)defaultRunLoopMode;
- (void).cxx_destruct;
@property(retain) FlurryTrackingManager *trackingManager; // @synthesize trackingManager=_trackingManager;
...
@property(retain, nonatomic) YMADFLAnimatedImage *animatedImage; // @synthesize animatedImage=_animatedImage;
